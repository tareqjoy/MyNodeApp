...
export class AuthorizeClientReq {
    ...
    constructor(clientId: string, redirect_uri: string, grant_type: "authorization_code", code: string);
    constructor(clientId?: string, redirect_uri?: string, type? : "code" | "authorization_code", code?: string) {
