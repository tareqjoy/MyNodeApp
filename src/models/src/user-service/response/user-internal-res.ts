export class UserInternalRes {
    ...
    constructor(toUsernames?: Map<string, string | null>, toUserIds?: Map<string, string | null>) {
        ...
        this.toUsernames = toUsernames ? (toUsernames.size == 0? undefined: mapToObject(toUsernames)): undefined;
        this.toUserIds = toUserIds ? (toUserIds.size == 0? undefined: mapToObject(toUserIds)): undefined;
    }
}
