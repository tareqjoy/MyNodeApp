import { AuthInfo, AuthSignInRes, InvalidRequest, UnauthorizedRequest } from '@tareqjoy/models';
...
export async function genAccessRefreshToken(redisClient: RedisClientType<any, any, any>,userId: string, deviceId: string): Promise<AuthSignInRes> {
