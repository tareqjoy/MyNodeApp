...
import { FollowersReq, FollowersReqInternal, UserInternalReq, UserInternalRes } from '@tareqjoy/models';
...
export async function parseAndExecuteQuery(isInternalEndpoint: boolean, userServiceHostUrl: string, req: Request, res: Response, neo4jSession: Session, query: string) {
