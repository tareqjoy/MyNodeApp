...
import { PostDetailsRes, SinglePost, UserInternalReq, UserInternalRes, Paging } from '@tareqjoy/models';
import { plainToInstance } from 'class-transformer';

const logger = log4js.getLogger();
logger.level = "trace";

export function getTimeSortedGetPostIdsByUserListQuery(userMongoIds: mongoose.Types.ObjectId[], highTime: number, lastPostId?: string): any {
    var query: any = {
...
export async function toResPosts(userServiceHostUrl: string, dbPosts: any, returnOnlyPostId: boolean, returnAsUsername: boolean, paging?: Paging): Promise<PostDetailsRes> {
